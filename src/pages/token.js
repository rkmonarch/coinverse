...
const Dashboard = () => {
  return (
    <Layout>
      <div className="flex flex-col space-y-8 justify-center max-w-[800px] mx-auto pb-32">
        <div className="flex items-center w-full bg-gradient-to-r from-emerald-500 to-lime-600 rounded-[30px] overflow-hidden shadow-lg">
          <div className="px-10 py-8 text-white">
            <div className="font-bold text-xl mb-2">TOKEN</div>
            <div className="font-bold text-md mb-2">
              Mint a personal or a community token on a fixed supply
              Already have a token? Import token into Coinvise
            </div>
          </div>
          <div className="flex mx-auto justify-center w-[100%]">
        ...
        <Input
          ...
          type="text"
          onChange={()=>{}}
          helper="(Optional) Create Tokens Directly To Your Multisig, Create One Here."
        />
        <Input
          id="description"
          name="description"
